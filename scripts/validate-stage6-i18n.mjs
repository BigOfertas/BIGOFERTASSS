...
if ((product.match(/<MotionButton/g) ?? []).length !== 2) fail("both desktop and mobile CTAs must use MotionButton");
...
for (const token of ["h-[64px] w-[104px]", "h-[44px] w-[44px]", "x: isDark ? 46 : 0", "stiffness: 300", "damping: 20"]) {
