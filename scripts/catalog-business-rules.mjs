...
const CLUB_DOMESTIC_RULES = Object.freeze([
  {
    patches: ["brasileirao", "libertadores", "sul-americana", "copa-do-brasil", "mundial-de-clubes"],
    leagueMarkers: ["BRASILEIRAO", "CAMPEONATO BRASILEIRO", "SERIE A BRASIL"],
    clubs: ["ATLETICO MINEIRO", "BAHIA", "BOTAFOGO", "CORINTHIANS", "CRUZEIRO", "FLAMENGO", "FLUMINENSE", "FORTALEZA", "GREMIO", "INTERNACIONAL", "PALMEIRAS", "SANTOS", "SAO PAULO", "VASCO"],
  },
  {
    ...
    clubs: ["BOCA JUNIORS", "RIVER PLATE", "RACING CLUB", "INDEPENDIENTE", "SAN LORENZO", "ESTUDIANTES", "VELEZ SARSFIELD"],
  },
  {
    patches: ["premier-league", "fa-cup"],
    leagueMarkers: ["PREMIER LEAGUE"],
    clubs: ["ARSENAL", "ASTON VILLA", "BOURNEMOUTH", "BRENTFORD", "BRIGHTON", "BURNLEY", "CHELSEA", "CRYSTAL PALACE", "EVERTON", "FULHAM", "LEEDS", "LIVERPOOL", "MANCHESTER CITY", "MAN CITY", "MANCHESTER UNITED", "MAN UNITED", "NEWCASTLE", "NOTTINGHAM FOREST", "SUNDERLAND", "TOTTENHAM", "WEST HAM", "WOLVES", "WOLVERHAMPTON"],
  },
  {
    patches: ["laliga", "copa-del-rey"],
    leagueMarkers: ["LA LIGA", "LALIGA"],
    clubs: ["ALAVES", "ATHLETIC BILBAO", "ATHLETIC CLUB", "ATLETICO MADRID", "BARCELONA", "CELTA", "ELCHE", "ESPANYOL", "GETAFE", "GIRONA", "LEVANTE", "MALLORCA", "OSASUNA", "OVIEDO", "RAYO VALLECANO", "REAL BETIS", "REAL MADRID", "REAL SOCIEDAD", "SEVILLA", "VALENCIA", "VILLARREAL"],
  },
  {
    patches: ["serie-a", "coppa-italia"],
    leagueMarkers: ["SERIE A ITALIA"],
    clubs: ["ATALANTA", "BOLOGNA", "CAGLIARI", "COMO", "FIORENTINA", "GENOA", "INTER DE MILAO", "INTER MILAN", "INTERNAZIONALE", "JUVENTUS", "LAZIO", "LECCE", "MILAN", "AC MILAN", "NAPOLI", "PARMA", "ROMA", "SASSUOLO", "TORINO", "UDINESE"],
  },
  {
    patches: ["bundesliga", "dfb-pokal"],
    leagueMarkers: ["BUNDESLIGA"],
    clubs: ["AUGSBURG", "BAYERN", "DORTMUND", "BORUSSIA DORTMUND", "BORUSSIA MONCHENGLADBACH", "EINTRACHT FRANKFURT", "FREIBURG", "HAMBURG", "HEIDENHEIM", "HOFFENHEIM", "KOLN", "COLOGNE", "LEIPZIG", "LEVERKUSEN", "BAYER LEVERKUSEN", "MAINZ", "ST PAULI", "STUTTGART", "UNION BERLIN", "WERDER BREMEN", "WOLFSBURG"],
  },
  {
    patches: ["ligue-1", "coupe-de-france"],
    leagueMarkers: ["LIGUE 1"],
    clubs: ["AUXERRE", "BREST", "LENS", "LILLE", "LORIENT", "LYON", "OLYMPIQUE LYON", "MARSEILLE", "MONACO", "NANTES", "NICE", "PARIS FC", "PSG", "PARIS SAINT GERMAIN", "RENNES", "STRASBOURG", "TOULOUSE"],
  },
  {
    patches: ["mls", "leagues-cup", "concacaf-champions-cup"],
    leagueMarkers: ["MLS", "MAJOR LEAGUE SOCCER"],
    clubs: ["ATLANTA UNITED", "AUSTIN FC", "CHARLOTTE FC", "CHICAGO FIRE", "CINCINNATI", "COLORADO RAPIDS", "COLUMBUS CREW", "DC UNITED", "FC DALLAS", "HOUSTON DYNAMO", "INTER MIAMI", "LA GALAXY", "LAFC", "LOS ANGELES FC", "MINNESOTA UNITED", "MONTREAL", "NASHVILLE", "NEW ENGLAND REVOLUTION", "NEW YORK CITY", "NYCFC", "NEW YORK RED BULLS", "ORLANDO CITY", "PHILADELPHIA UNION", "PORTLAND TIMBERS", "REAL SALT LAKE", "SAN DIEGO FC", "SAN JOSE EARTHQUAKES", "SEATTLE SOUNDERS", "SPORTING KANSAS CITY", "ST LOUIS CITY", "TORONTO FC", "VANCOUVER WHITECAPS"],
  },
  {
    patches: ["liga-mx", "leagues-cup", "concacaf-champions-cup"],
    leagueMarkers: ["LIGA MX"],
    clubs: ["AMERICA MEXICO", "CLUB AMERICA", "CHIVAS", "GUADALAJARA", "CRUZ AZUL", "MONTERREY", "PACHUCA", "PUMAS", "TIGRES"],
  },
  {
...
const NO_PATCH_PRODUCT = /\b(BASQUETE|BASKET|NBA|SHORTS?|CALCAO|TREINO|VIAGEM|CORTA VENTO|WINDBREAKER|JAQUETA|CASACO|AGASALHO)\b/;
