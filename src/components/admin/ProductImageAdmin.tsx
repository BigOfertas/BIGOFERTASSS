...
export function ProductImageAdmin() {
  ...
  async function handleArchive(image: ProductImage) {
    if (!selectedProductId || busyImageId) return;

    const confirmed = window.confirm(
      "Retirar esta imagem do produto? Ela deixará de aparecer na loja.",
    );
    if (!confirmed) return;
              ...
              return (
                ...
                >
                  ...
                  <div className="space-y-3 border-t border-gray-200 bg-white p-4">
                    <p className="truncate text-xs text-gray-500" title={image.original_filename ?? undefined}>
