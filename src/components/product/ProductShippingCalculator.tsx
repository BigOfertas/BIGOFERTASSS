      ...
      {result ? (
        <div className="mt-4 space-y-2">
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <span className="block text-[11px] text-gray-500">
                  {formatTransitLabel(quote)} após a preparação
                </span>
              </div>
          ...
          <p className="pt-1 text-[11px] leading-5 text-gray-500">
            Preparação em até {result.productionBusinessDays} dias úteis antes do envio. O prazo
            final pode variar conforme a localidade.
          </p>
        </div>
      ) : null}
    </section>
