          ...
          return (
            <div key={step} className="contents">
              <div className="flex min-w-0 flex-1 items-center gap-2">
                <span
                  className={`flex h-9 w-9 flex-none items-center justify-center rounded-full text-sm font-black ${completed ? "bg-emerald-600 text-white" : active ? "bg-red-600 text-white" : "bg-gray-100 text-gray-400"}`}
                >
                ...
                <div className="min-w-0">
                  ...
                  <p
                    className={`truncate text-sm font-bold ${active ? "text-gray-950" : "text-gray-500"}`}
                  >
                    {label}
                  </p>
                </div>
      ...
      <main className="flex min-h-screen items-center justify-center bg-[#f7f7f7] px-4">
        <div className="max-w-md rounded-2xl border border-amber-200 bg-white p-7 text-center shadow-sm">
          ...
          <p className="mt-2 text-sm leading-6 text-gray-600">
            A {BRAND.officialName} só libera a finalização da compra depois da confirmação do
            e-mail.
          </p>
        </div>
      </main>
      ...
      <main className="flex min-h-screen items-center justify-center bg-[#f7f7f7] px-4">
        <div className="max-w-md rounded-2xl border border-amber-200 bg-white p-7 text-center shadow-sm">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Algum item precisa ser revisado antes de continuar.
          </p>
          <Button asChild className="mt-5 bg-red-600 text-white hover:bg-red-700">
        ...
        <div className="mt-5 grid gap-5 lg:grid-cols-[minmax(0,1fr)_320px]">
          <section className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm sm:p-7">
            {step === 1 ? (
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-gray-500">
                  Use os dados salvos ou edite somente se algo mudou.
                </p>
                ...
                {identity && isCheckoutIdentityComplete(identity) && !editingIdentity ? (
                  <div className="mt-6 rounded-2xl border border-emerald-200 bg-emerald-50/50 p-5">
                    <div className="flex items-start gap-3">
                      <span className="flex h-10 w-10 flex-none items-center justify-center rounded-full bg-emerald-600 text-white">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                          {formatBrazilianPhone(identity.phone ?? "")}
                        </p>
                      </div>
                    </div>
                    <div className="mt-5 grid grid-cols-2 gap-2">
                      <Button variant="outline" onClick={() => setEditingIdentity(true)}>
                        Editar
                      </Button>
                      <Button
                        ...
                        onClick={() => setStep(2)}
                      >
                        Usar estes dados <ArrowRight className="ml-2 h-4 w-4" />
                      </Button>
                    </div>
                  </div>
                ) : (
                  <>
                    <div className="mt-6 grid gap-5 sm:grid-cols-2">
                      ...
                      {personType === "individual" ? (
                        ...
                        <>
                          <label className="text-sm font-semibold text-gray-800">
                            ...
                            <input
                              value={cnpj}
                              onChange={(event) => setCnpj(formatBrazilianCnpj(event.target.value))}
                              className={inputClass}
                              inputMode="numeric"
                      ...
                      <label className="text-sm font-semibold text-gray-800">
                        ...
                        <input
                          ...
                          onChange={(event) =>
                            setSecondaryPhone(formatBrazilianPhone(event.target.value))
                          }
                          className={inputClass}
                          inputMode="tel"
                          placeholder="(84) 99999-9999"
                    ...
                    <div className="mt-7 flex items-center justify-between gap-3">
                      {identity && isCheckoutIdentityComplete(identity) ? (
                      ...
                      <Button
                        ...
                        disabled={!identityFormValid || savingIdentity}
                        className="bg-red-600 text-white hover:bg-red-700"
                      >
                        {savingIdentity ? (
            ...
            {step === 2 ? (
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-gray-500">
                  Escolha um endereço salvo ou cadastre o local da entrega.
                </p>
                {addresses.length > 0 && !showAddressForm ? (
                  <div className="mt-6 space-y-3">
                    {addresses.map((address) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full rounded-xl border p-4 text-left ${selected ? "border-red-500 bg-red-50/50" : "border-gray-200 bg-white"}`}
                        >
                          <div className="flex items-start justify-between gap-4">
                            ...
                            <span
                              className={`flex h-6 w-6 items-center justify-center rounded-full border ${selected ? "border-red-600 bg-red-600 text-white" : "border-gray-300 text-transparent"}`}
                            >
                    ...
                    <button
                      ...
                      className="w-full rounded-xl border border-dashed border-gray-300 px-4 py-4 text-sm font-bold text-gray-600 hover:border-red-300 hover:text-red-700"
                    >
                  ...
                  <div className="mt-6">
                      ...
                      <label className="text-sm font-semibold text-gray-800 sm:col-span-2">
                        ...
                        <div className="mt-1.5 flex gap-2">
                          <input
                            ...
                            className="h-11 min-w-0 flex-1 rounded-lg border border-gray-300 bg-white px-3 text-sm outline-none focus:border-red-500 focus:ring-4 focus:ring-red-50"
                            inputMode="numeric"
                    ...
                    <label className="mt-5 flex cursor-pointer items-start gap-3 rounded-xl border border-emerald-200 bg-emerald-50/60 p-4">
                      ...
                      <span>
                        ...
                        <span className="mt-1 block text-xs leading-5 text-emerald-800/80">
                          Na próxima compra ele já aparecerá selecionado.
                        </span>
                      </span>
                    </label>
                    <div className="mt-6 flex items-center justify-between gap-3">
                      <Button
                        variant="outline"
                        onClick={() =>
                          addresses.length > 0 ? setShowAddressForm(false) : setStep(1)
                        }
                      >
                        <ArrowLeft className="mr-2 h-4 w-4" />
                        Voltar
                      ...
                      <Button
                        onClick={() => void saveAddressAndContinue()}
                        disabled={!addressDraftValid || savingAddress}
                        className="bg-red-600 text-white hover:bg-red-700"
                      >
                        {savingAddress ? (
                          <LoaderCircle className="mr-2 h-4 w-4 animate-spin" />
            ...
            {step === 3 ? (
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-gray-500">
                  Veja o transporte e, principalmente, a previsão total incluindo a preparação.
                </p>
                {discount.freeShipping ? (
                  <div className="mt-5 flex items-center gap-3 rounded-xl border border-emerald-200 bg-emerald-50 p-4 text-sm font-bold text-emerald-800">
                    ...
                    quotes.map((quote) => {
                      ...
                      return (
                        <button
                          ...
                          className={`flex w-full items-center gap-4 rounded-xl border p-4 text-left ${selected ? "border-red-500 bg-red-50/50" : "border-gray-200 bg-white hover:border-gray-300"}`}
                        >
                          <span
                            className={`flex h-10 w-10 items-center justify-center rounded-xl ${selected ? "bg-red-600 text-white" : "bg-gray-100 text-gray-600"}`}
                          >
                            {selected ? (
                              <Check className="h-5 w-5" />
                            ) : (
                          ...
                          <span className="min-w-0 flex-1">
                            <strong className="block text-sm text-gray-950">{quote.service}</strong>
                            <span className="mt-1 block text-xs text-gray-500">
                              Transporte: {formatTransitLabel(quote)}
                            </span>
                            <span className="mt-1 block text-xs font-bold text-gray-800">
                              Previsão total:{" "}
                              {formatTotalDeliveryLabel(productionBusinessDays, quote)}
                            </span>
                          </span>
                          <strong
                            className={discount.freeShipping ? "text-emerald-700" : "text-gray-950"}
                          >
                            {discount.freeShipping ? "Grátis" : currency.format(quote.totalPrice)}
                          </strong>
                        </button>
                      );
                    })
                ...
                {productionBusinessDays > 0 ? (
                  <p className="mt-4 text-xs leading-5 text-gray-500">
                    A previsão total acima já inclui até {productionBusinessDays} dias úteis de
                ...
                <div className="mt-6 flex items-center justify-between gap-3">
                  ...
                  <Button
                    ...
                    className="bg-red-600 text-white hover:bg-red-700"
                  >
                    Revisar pedido <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                </div>
              </div>
            ) : null}
            ...
            {step === 4 ? (
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-gray-500">
                  Confira os dados abaixo. O pagamento será feito na InfinitePay.
                </p>
                <div className="mt-6 space-y-4">
                  <div className="rounded-xl border border-gray-200 p-4">
                    <div className="flex items-center justify-between gap-3">
                      <strong className="text-sm text-gray-950">Comprador</strong>
                      <button
                        type="button"
                        onClick={() => {
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      {identity ? maskedDocument(identity) : ""} ·{" "}
                      {formatBrazilianPhone(identity?.phone ?? "")}
                    </p>
                  </div>
                  <div className="rounded-xl border border-gray-200 p-4">
                    <div className="flex items-center justify-between gap-3">
                      <strong className="text-sm text-gray-950">Endereço</strong>
                      <button
                        type="button"
                        onClick={() => setStep(2)}
                        className="text-xs font-bold text-red-600"
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      ...
                      {formatPostalCode(selectedAddress?.postal_code ?? "")}
                    </p>
                  </div>
                  <div className="rounded-xl border border-gray-200 p-4">
                    <div className="flex items-center justify-between gap-3">
                      <strong className="text-sm text-gray-950">Entrega</strong>
                      <button
                        type="button"
                        onClick={() => setStep(3)}
                        className="text-xs font-bold text-red-600"
                    ...
                    <p className="mt-2 text-sm text-gray-700">
                      ...
                      {selectedQuote ? formatTransitLabel(selectedQuote) : ""}
                    </p>
                    {selectedQuote ? (
                      <p className="mt-1 text-xs font-bold text-gray-700">
                        Previsão total:{" "}
                        {formatTotalDeliveryLabel(productionBusinessDays, selectedQuote)}
                      </p>
                    ) : null}
                    <p
                      className={`mt-1 text-xs font-bold ${discount.freeShipping ? "text-emerald-700" : "text-gray-500"}`}
                    >
                      {discount.freeShipping
                        ? "Frete grátis"
                        : selectedQuote
                          ? currency.format(selectedQuote.totalPrice)
                          : ""}
                    </p>
                  </div>
                  <div className="rounded-xl border border-gray-200 p-4">
                    ...
                    <div className="mt-3 divide-y divide-gray-100">
                      {cart.map((item) => (
                        ...
                        >
                          ...
                          <strong className="flex-none text-sm text-gray-900">
                ...
                <div className="mt-7 flex items-center justify-between gap-3">
                  ...
                  <Button
                    ...
                    disabled={
                      ...
                      !selectedAddress ||
                      !selectedQuote ||
                      !isCheckoutIdentityComplete(identity)
                    }
                    className="bg-red-600 text-white hover:bg-red-700"
                  >
                    {checkoutLoading ? (
          ...
          <aside className="h-fit rounded-2xl border border-gray-200 bg-white p-5 shadow-sm lg:sticky lg:top-5">
            ...
            <div className="mt-4 space-y-3 text-sm">
              ...
              <div className="border-t border-gray-100 pt-3">
                <div className="flex items-end justify-between gap-4">
                  <strong className="text-gray-950">Total</strong>
                  <strong className="text-xl text-red-600">{currency.format(finalTotal)}</strong>
                </div>
              </div>
            </div>
            {discount.nextTier ? (
              <div className="mt-4 rounded-xl bg-emerald-50 p-3 text-xs leading-5 text-emerald-800">
                ...
                Adicione mais {discount.nextTier.unitsRemaining}{" "}
                {discount.nextTier.unitsRemaining === 1 ? "peça" : "peças"} para chegar a{" "}
                {discount.nextTier.percent}% de desconto
            ...
            <div className="mt-5 flex items-start gap-2 border-t border-gray-100 pt-4 text-xs leading-5 text-gray-500">
              ...
              Você revisará tudo antes de seguir para a InfinitePay.
            </div>
          </aside>
        </div>
      </main>
