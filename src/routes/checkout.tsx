...
import { formatTransitLabel, requestShippingQuotes, type ShippingQuote } from "@/lib/shipping";
      ...
      <main className="flex min-h-screen items-center justify-center bg-[#f7f7f7] px-4">
        <div className="max-w-md rounded-2xl border border-amber-200 bg-white p-7 text-center shadow-sm">
          ...
          <p className="mt-2 text-sm leading-6 text-gray-600">
            A {BRAND.officialName} só libera a conta e a finalização da compra depois da confirmação
          ...
          <section className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm sm:p-7">
            {step === 1 ? (
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-gray-500">
                  Precisamos destes dados para identificar o comprador e entrar em contato sobre o
                  pedido.
                </p>
                    ...
                    <label className="mt-5 flex cursor-pointer items-start gap-3 rounded-xl border border-emerald-200 bg-emerald-50/60 p-4">
                      ...
                      <span>
                        <strong className="block text-sm text-emerald-950">
                          Deseja deixar este como seu endereço padrão? :)
                        </strong>
                        <span className="mt-1 block text-xs leading-5 text-emerald-800/80">
                          Na próxima compra ele já aparecerá selecionado para você.
                        </span>
                      </span>
                    </label>
            ...
            {step === 3 ? (
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-gray-500">
                  Selecione a opção que combina melhor com seu pedido.
                </p>
              ...
              <div>
                ...
                <div className="mt-6 space-y-4">
                  <div className="rounded-xl border border-gray-200 p-4">
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      {identity?.person_type === "business"
                        ? `CNPJ ${formatBrazilianCnpj(identity.cnpj ?? "")}`
                        : `CPF ${formatBrazilianCpf(identity?.cpf ?? "")}`}{" "}
