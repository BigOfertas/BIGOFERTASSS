        ...
        <div key={index} className="animate-pulse">
          ...
          <div className="space-y-2.5">
            {Array.from({ length: 4 }).map((__, item) => (
              <div key={item} className="h-3 w-32 rounded bg-gray-100" />
            ))}
          </div>
        </div>
      ))}
      ...
      <div className="flex min-h-screen flex-col bg-white">
        ...
        <main className="flex flex-grow items-center justify-center p-8">
          <div className="max-w-md text-center">
            ...
            <Button asChild className="mt-6 bg-red-600 text-white hover:bg-black">
      ...
      <main className="mx-auto w-full max-w-7xl flex-grow px-4 py-7 md:py-10 lg:px-8">
        ...
        >
          ...
          {breadcrumbTail ? (
            <>
              <ChevronRight className="h-3.5 w-3.5" />
              <span className="max-w-[260px] truncate text-gray-900" aria-current="page">
                {breadcrumbTail}
              </span>
            </>
          ) : null}
        ...
        <div className="mb-7 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            <h1 className="text-2xl font-black uppercase tracking-tight text-gray-950 md:text-3xl">
              Produtos
            </h1>
            {search.q ? (
            ...
            {!isLoading && catalog ? (
              <p className="mt-1 text-xs font-medium text-gray-500">
                {catalog.total.toLocaleString("pt-BR")} produto(s)
              </p>
            ) : null}
          </div>
        ...
        search.maxPrice !== undefined ? (
          <div className="mb-6 flex flex-wrap items-center gap-2 border-y border-gray-100 py-3">
            <span className="mr-1 text-[10px] font-black uppercase tracking-[0.14em] text-gray-400">
              Filtros ativos
            </span>
            ...
            {search.minPrice !== undefined || search.maxPrice !== undefined ? (
              ...
              >
                ...
                {search.minPrice !== undefined ? `R$ ${search.minPrice}` : "mín."} –{" "}
                {search.maxPrice !== undefined ? `R$ ${search.maxPrice}` : "máx."}
                <X className="h-3 w-3" />
              </button>
            ) : null}
            <button
              ...
              className="ml-1 text-xs font-black text-red-600 hover:text-black"
            >
              Limpar tudo
            </button>
          </div>
          ...
          <Sheet open={filtersOpen} onOpenChange={setFiltersOpen}>
            ...
            >
              <SheetHeader className="border-b border-gray-100 px-5 py-4 text-left">
                ...
                <SheetDescription>
                  As opções e contagens se ajustam ao que você já selecionou.
                </SheetDescription>
              </SheetHeader>
            ...
            {isLoading ? (
              ...
              <div className="mx-auto flex max-w-lg flex-col items-center py-20 text-center">
                ...
                <p className="mt-2 text-sm leading-6 text-gray-500">
                  Tente remover um filtro, usar uma busca mais curta ou explorar todo o catálogo.
                </p>
